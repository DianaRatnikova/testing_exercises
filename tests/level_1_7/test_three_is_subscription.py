...
def test__is_subscription__short_history():
    expense1 = Expense(amount=decimal.Decimal('10.8'), 
    ...
    history_list = [expense1, expense1]
    assert is_subscription(expense1, history_list) == False
...
def test__is_subscription__long_history():
    expense1 = Expense(amount=decimal.Decimal('10.8'), 
                       ...
                       spent_at=datetime.datetime(2005, 1, 14),
                       category=ExpenseCategory("SUPERMARKET"))
    history_list = [expense1, expense1, expense1, expense1, expense1]
    assert is_subscription(expense1, history_list) == False
...
def test__is_subscription__true():
   ...
   expense1_1 = Expense(amount=decimal.Decimal('10.8'), 
                   currency=Currency("USD"), 
                   card = BankCard(last_digits='234', owner="John"), 
                   spent_in="green apple", 
   ...
   expense1_2 = Expense(amount=decimal.Decimal('10.8'), 
                   currency=Currency("USD"), 
                   card = BankCard(last_digits='234', owner="John"), 
                   spent_in="green apple", 
   ...
   expense1_3 = Expense(amount=decimal.Decimal('10.8'), 
               currency=Currency("USD"), 
               card = BankCard(last_digits='234', owner="John"), 
               spent_in="green apple", 
   ...
   history_list = [expense1, expense1_1, expense1_2, expense1_3]
   assert is_subscription(expense1, history_list) == True